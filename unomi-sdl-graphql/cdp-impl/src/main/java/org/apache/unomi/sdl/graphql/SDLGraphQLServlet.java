 ...
 */
package org.apache.unomi.sdl.graphql;
...
import org.apache.unomi.sdl.graphql.schema.GraphQLProvider;
...
public class SDLGraphQLServlet extends HttpServlet {
    ...
    @Reference
    public void setGraphQLProvider(GraphQLProvider graphQLProvider) {
